	...
	<div id="wrapper">
		...
		<div class="noidung">
			...
			<div class="row" style="margin-left:30px; margin-right:30px">
				<h2><strong>Thêm rank mới</strong>
				<a href="rank.jsp" style="float: right"><button class="btn btn-info"><i class="fa fa-undo" aria-hidden="true"></i>  Trở về</button></a>
				</h2>
				<hr>
			</div>
			<div class="noidungcon">
				<form id="addRank" data-parsley-validate class="form-horizontal form-label-left"  action="../../Rank?action=ADD" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="rankID" name="rankID" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-rankID"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="rank"  name="rank" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-rank"></p>
                               </div>
