...
<% String classID = request.getParameter("classID"); 
	Classed us = ClassedDAO.mapClassed.get(classID);
%>
	...
	<div id="wrapper">
		...
		<div class="noidung">
			<div class="row" style="margin-left:30px; margin-right:30px">
				<h2><strong>Sửa thông tin lớp học</strong>
			...
			<div class="noidungcon">
				<form id="editClass"  class="form-horizontal form-label-left"  action="../../Classed?action=EDIT&classID=<%=classID %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="classID" name="ID" class="form-control col-md-7 col-xs-12" value="<%=us.getClassID()%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-classID"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="className"  name="className" class="form-control col-md-7 col-xs-12" value="<%=us.getClassName()%>">
                               </div>
                               <div class="col-sm-2">
