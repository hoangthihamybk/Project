				...
				<div class="row">
					...
					%>
                        <tr>
                          ...
                          <td><%=u.getScoreBoard() %></td>
                          <td><%=EvaluationDAO.mapEvaluation.get(u.getEvaluationID()).getContent()%></td>
                          <td><center><a href="edit.jsp?scoreBoardID=<%=u.getSBID()%>"><button class="btn btn-sm glyphicon glyphicon-edit btn-success"></button></a></center></td>
                          <td><center><a href="../../ScoreBoard?action=DEL&scoreBoardID=<%=u.getSBID()%>"><button class=" btn btn-sm glyphicon glyphicon-trash btn-danger"></button></a></center></td>
                        </tr>
                       <%} %>
