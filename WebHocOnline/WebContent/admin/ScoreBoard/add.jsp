	...
	<div id="wrapper">
		...
		<div class="noidung">
			...
			<div class="row" style="margin-left:30px; margin-right:30px">
				<h2><strong>Thêm ScoreBoard mới</strong>
			...
			<div class="noidungcon">
				<form id="addScoreBoard" data-parsley-validate class="form-horizontal form-label-left"  action="../../ScoreBoard?action=ADD" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="ScoreBoardID" name="scoreBoardID" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="timeEnd"  name="timeEnd" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-timeEnd"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="numberOfCorrect"  name="numberOfCorrect" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="score"  name="score" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-score"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                  <input type="number" id="accumulatedPoints"  name="accumulatedPoints" class="form-control col-md-7 col-xs-12" >
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>  Thêm bảng điểm</button>
                        </div>
                      </div>
