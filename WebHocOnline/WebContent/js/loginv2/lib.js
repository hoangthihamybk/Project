(function ($) {
        ...
        signInCallback: function (authResult) {
            if (authResult['code']) {
                ...
                $.ajax({
                    ...
                    error: function (e) {
                        showError('ÄĂ£ cĂ³ lá»—i xáº£y ra trong quĂ¡ trĂ¬nh Ä‘Äƒng nháº­p, vui lĂ²ng thá»­ láº¡i.');
                    }
                });
            } else {
    ...
    function showLoading(type) {
        ...
        $('#loginSocialModal').find('.loaderv2-text').html('<p class="text-center">Báº¡n Ä‘ang Ä‘Äƒng nháº­p báº±ng ' + type + '. Vui lĂ²ng chá» trong giĂ¢y lĂ¡t.</p>');
