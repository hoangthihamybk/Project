//ThĂªm sá»± kiá»‡n onchange vĂ o trong kiá»ƒm tra form
(function($) {
...
}, "Thiáº¿u thĂ´ng tin trÆ°á»ng há»c");
...
$(document).ready(function(){
    //Náº¿u cĂ³ f thĂ¬ khĂ´ng cho táº¯t modal báº±ng backdrop
    if(getUrlParam('f')){
        $('#loginModal, #userInfoConfirmModal').data('backdrop', 'static');
    }
    //Hiá»ƒn thá»‹ form Ä‘Äƒng kĂ½ há»c miá»…n phĂ­
    ...
    $('#userInfoConfirmModal [name="city"]').change(function(e){
        ...
        $.ajax({
            ...
            success: function($schools){
                var $schoolHtml = '<option value=""> -- Chá»n trÆ°á»ng há»c -- </option>';
                for($sID in $schools){
    ...
    $("#user-info-confirm-form").validate({
        ...
        messages:{
            fullname:{
                required: 'ChÆ°a nháº­p há» tĂªn',
            },
            /*school_class:{
                required: 'ChÆ°a chá»n lá»›p',
            },
            city:{
                required: 'ChÆ°a chá»n Tá»‰nh/ThĂ nh phá»‘',
            },
            school_id:{
                schoolrequired: 'ChÆ°a chá»n trÆ°á»ng há»c',
            },
            school:{
                schoolrequired: 'ChÆ°a nháº­p trÆ°á»ng há»c',
            },*/
            phone2:{
                ...
                $.ajax({
                    ...
                    success: function($response){
                        switch($response.status){
                            ...
                            break;
                            case 'error':
                                alert('Xáº£y ra lá»—i, vui lĂ²ng liĂªn há»‡ tá»›i ÄÆ°á»ng dĂ¢y nĂ³ng: 0936-58-58-12');
                            break;
                        }
                        $thisForm.removeClass('waitting');
                    }
    ...
    //Báº¯n sá»± kiá»‡n cho chÆ°Æ¡ng trĂ¬nh há»c thá»­
