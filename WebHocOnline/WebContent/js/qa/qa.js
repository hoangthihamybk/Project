var QA = QA || {
        ...
        showCommentBlock: function (scormId, data, count, countMore, page, firstPage, guest, targetId, type, question) {
            ...
            if (countMore) {
                var loadMore = '<li class="more" data-target="'+ targetId +'" data-question="'+ question +'" scormid="' + scormId + '" page="' + (parseInt(page) + 1) + '">Xem thĂªm ' + countMore + ' trao Ä‘á»•i bĂ i</li>';
        ...
        loadMoreComments: function (scormId, data, count, countMore, page, firstPage, guest, targetId, question) {
            ...
            if (countMore > 0) {
                html += '<li class="more" data-target="'+ targetId +'" data-question="'+ question +'" scormid="' + scormId + '" page="' + (parseInt(page) + 1) + '">Xem thĂªm ' + countMore + ' trao Ä‘á»•i bĂ i</li>';
            }
        ...
        loadMoreReplies: function (id, data, count, countMore, page, firstPage, guest, scormId, question) {
            ...
            if (countMore) {
                html += '<li class="more" scormid="' + scormId + '" data-question="'+ question +'" qaid="' + id + '" page="1" style="margin-left: 0 !important;">Xem thĂªm ' + countMore + ' tráº£ lá»i</li>';
            }
