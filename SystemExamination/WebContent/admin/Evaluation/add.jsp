...
<title>Thêm bảng xếp hạng</title>
	...
	<div id="wrapper">
		...
		<div class="noidung">
			...
			<div class="noidungcon">
				<form id="addEvaluation" data-parsley-validate class="form-horizontal form-label-left"  action="../../Evaluation?action=ADD" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="evaluationID" name="evaluationID" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="title" name="title" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-title"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <textarea id="content" name="content" class="form-control col-md-7 col-xs-12" value=""></textarea> 
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-content"></p>
                               </div>
 						...
 						<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" id="">Pertence of score<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="number" id="pertence" name="pertenceOfPoint" class="form-control col-md-7 col-xs-12" value="">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>  Thêm xếp hạng</button>
                        </div>
                      </div>
