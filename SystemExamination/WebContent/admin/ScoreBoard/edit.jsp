				...
				<form id="editScoreBoard"  class="form-horizontal form-label-left"  action="../../ScoreBoard?action=EDIT&scoreBoardID=<%=scoreBoardID %>" method="post">
 					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="ScoreBoardID" name="ID" class="form-control col-md-7 col-xs-12" value="<%=us.getScoreBoardID()%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="number" id="score"  name="score" class="form-control col-md-7 col-xs-12" value="<%=us.getScore()%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-score"></p>
                               </div>
